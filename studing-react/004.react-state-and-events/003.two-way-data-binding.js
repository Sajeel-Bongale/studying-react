/*
    Link: https://www.udemy.com/course/react-the-complete-guide-incl-redux/learn/lecture/25596016?start=0#announcements

    Two way data binding allows us to attach state to an input value.

    With this, when the input value changes, the state updates and when the state value changes it
    in turn triggers an update on the input.
