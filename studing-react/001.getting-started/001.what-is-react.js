/*
    ...
    only those parts of the page that need changing.

    JavaScript in the browser is able to manipulate to so-called Dom, the HTML elements
    that are rendered onto the screen. And that allows us to change what the users sees without
    fetching a new HTML page.
    ...
    stays maintainable and manageable. React, the library, will do the heavy lifting
